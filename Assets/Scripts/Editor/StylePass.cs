...
namespace InteriorEditor
{
    ...
    public static class StylePass
    {
        ...
        public static void Apply()
        {
            ...
            titan.SetFloat("_PatternScale", 8f);
            titan.SetFloat("_BandStretch", 1f);
            titan.SetFloat("_Belts", .2f);
            titan.SetFloat("_ClearThreshold", .37f);
            titan.SetFloat("_RimPixels", 6f);
            titan.SetFloat("_SaturnFill", 1f);
            titan.SetFloat("_CloudDetail", .8f);
            titan.SetFloat("_HazeWidth", .2f);
            titan.SetFloat("_VeilStrength", .48f);
            ...
            titan.SetColor("_CloudShadow", Hex("#372D15"));
            titan.SetColor("_ClearDay", Hex("#5D179C"));
